...
namespace StoryGraph
{
    public class StoryGraphWindow : EditorWindow
    {
        ...
        [MenuItem("Window/StoryGraph")]
        static void Init()
        {
            var window = (StoryGraphWindow)EditorWindow.GetWindow(typeof(StoryGraphWindow));
        ...
        /// </summary>
        [MenuItem("Window/Open StoryGraphView")]
        public static void Open()
        {
            GetWindow<StoryGraphWindow>("StoryGraphView");
        }
        ...
        protected void OnEnable()
        {
            ...
            if (File.Exists(path))
            {
                Editor.StoryGraphSaveUtility.LoadGraph(path, graphView);
            }
        ...
        private void OnDestroy()
        {
            ...
            Editor.StoryGraphSaveUtility.SaveWindowInfo(graphView);
        }
        ...
        private void Save()
        {
            ...
            var dataIsSaved = Editor.StoryGraphSaveUtility.SaveGraph(graphView);
