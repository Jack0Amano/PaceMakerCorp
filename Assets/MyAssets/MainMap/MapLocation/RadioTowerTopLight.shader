...
Shader "LoneStar/RadioTowerTopLight"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEEnd][ASEBegin][HDR]_Emission("Emission", Color) = (0,0,0,0)
	...
	SubShader
	{
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = _Emission.a;
...
/*ASEBEGIN
Version=18935
320.5714;79.42857;930;729.8571;919.9496;376.7082;1.3;True;False
Node;AmplifyShaderEditor.ColorNode;10;-434.3716,51.64655;Inherit;False;Property;_Emission;Emission;0;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
